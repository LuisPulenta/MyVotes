    ...
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(EditUserViewModel view)
        {
            if (ModelState.IsValid)
            {
                ...
                appUser.User.Document = view.Document;
                appUser.User.FirstName = view.FirstName;
                appUser.User.LastName = view.LastName;
                appUser.User.Address = view.Address;
                appUser.User.PhoneNumber = view.PhoneNumber;
